...
import ThemeEntityI, { ColumnSortEntityI, MainConfStoreShemaI, TableOptionsEntityI, TablesOptionsEntityI, mainConfStoreShema } from '@dataAccess/entities/mainConfigEntityI'
